...
export const addScheduleSuccess = (_id: string, text: string, date: any): ScheduleAction =>
...
export const updateScheduleDateSuccess = (_id: string, date: any): ScheduleAction =>
